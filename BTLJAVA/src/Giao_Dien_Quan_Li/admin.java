...
import Giao_Dien_Bat_Dau.welcome;
/**
 *
 * @author Koyomi
 */
public class admin extends javax.swing.JFrame {
    ...
    private them_sach ts; 
    private quan_li_sach qls;
    private quan_li_doc_gia qldg;
    /**
    ...
    private void initComponents() {
        ...
        jButton4.setText("Quản Lí Độc Giả");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon_image/iconset4/icon/bg3.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1000, 710));

        jMenu1.setText("Hệ Thống Admin");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (qldg == null){
            qldg = new quan_li_doc_gia();
            tplMainBoard.addTab("Quản Lí Độc Giả",qldg);
        }
        tplMainBoard.setSelectedComponent(qldg);
